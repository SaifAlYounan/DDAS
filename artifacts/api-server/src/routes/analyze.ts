...
{"status":"scored","transaction_summary":"one-line summary","transaction_type":"e.g. EPC Contract, PPA, JV Agreement, M&A, Carbon Offtake, Consultancy","required_signatories":"Concrete role names required to approve this specific contract, e.g. 'VP Projects + General Counsel sign-off required' or 'CEO + CFO + Board resolution required'. Base this on the contract type, value, and complexity — not just a signature count. Use titles that would exist in a UAE renewable energy developer.","contract_analysis":{"red_flags":[{"issue":"description","severity":"high|medium|low","clause_reference":"if identifiable","recommendation":"what to do"}],"missing_provisions":[{"provision":"what is missing","risk":"why it matters","recommendation":"what to add"}],"positive_features":[{"feature":"description","benefit":"why good"}],"assumptions":[{"assumption":"what was assumed","impact":"how this affects scoring"}]},"scores":{"financial_exposure":{"score":0,"rationale":""},"reversibility":{"score":0,"rationale":""},"regulatory_compliance":{"score":0,"rationale":""},"reputational_impact":{"score":0,"rationale":""},"precedent_setting":{"score":0,"rationale":""},"stakeholder_complexity":{"score":0,"rationale":""}},"key_recommendations":["recommendation 1","recommendation 2"],"overall_risk_narrative":"2-3 sentence narrative of the overall risk picture"}
